...
const TableHeaderControls = ({
  ...
  const isPdf = btnTxtArray?.find((x) => x.btnType === HEADER_BTN.PDF_DOWNLOAD)
    ...
    <>
      ...
      >
        <div className='className flex  items-center justify-center gap-3'>
          ...
          {headingInsured && <h1 className='text-sm font-black'>{headingInsured}</h1>}
        </div>
        ...
        >
          ...
          {isPdf && (
            ...
            >
              {isPdf.btnText ?? HEADER_BTN.PDF_DOWNLOAD}
            </Button>
          )}
        </Box>
      </Box>
